...
@router.post("/", response_model=BarResponse, status_code=status.HTTP_201_CREATED, summary="Create a coffee bar")
...
@router.patch("/{bar_id}", response_model=BarResponse, summary="Update coffee bar")
...
@router.delete("/{bar_id}", status_code=status.HTTP_204_NO_CONTENT, summary="Delete coffee bar")
