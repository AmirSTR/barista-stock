...
class Order(Base):
    ...
    bar_id: Mapped[int] = mapped_column(Integer, ForeignKey("bars.id"), nullable=False, index=True)
    ...
    packer_name: Mapped[Optional[str]] = mapped_column(String(255), nullable=True)
    shipped_by: Mapped[Optional[str]] = mapped_column(String(255), nullable=True)
...
class OrderItem(Base):
    ...
    confirmed_qty: Mapped[float] = mapped_column(Float, default=0.0, nullable=False)
