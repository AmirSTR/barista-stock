...
from app.services.ocr_service import OCRService, parse_invoice_photo
...
@pytest.mark.asyncio
async def test_ocr_service_demo_fallback_when_no_api_key():
    """Test OCRService fallback to demo data when no API keys are present."""
