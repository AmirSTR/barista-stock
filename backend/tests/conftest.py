...
async def client(db_session: AsyncSession) -> AsyncGenerator[AsyncClient, None]:
    ...
    async def override_admin_api_key():
        return None

    async def override_telegram_user():
        return {"user": {"id": 12345}}

    app.dependency_overrides[get_db] = override_get_db
    app.dependency_overrides[require_admin_api_key] = override_admin_api_key
    app.dependency_overrides[require_telegram_user] = override_telegram_user
